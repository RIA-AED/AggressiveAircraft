...
public class ExplosiveBulletRenderer extends EntityRenderer<ExplosiveBulletEntity> {
    ...
    @Override
    public void render(ExplosiveBulletEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(ExplosiveBulletEntity entity) {
        return TEXTURE;
    }
}
