...
import dev.ignis.aggressiveaircraft.entities.HomingRocketEntity;
...
public class HomingRocketRenderer extends EntityRenderer<HomingRocketEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.tryBuild(AggressiveAircraft.MODID, "textures/entity/homing_rocket.png");
    ...
    @Override
    public void render(HomingRocketEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(HomingRocketEntity entity) {
        return TEXTURE;
    }
}
