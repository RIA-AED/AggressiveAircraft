...
public class ClusterBombletRenderer extends EntityRenderer<ClusterBombletEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.tryBuild(AggressiveAircraft.MODID, "textures/entity/cluster_bomblet.png");
    ...
    @Override
    public void render(ClusterBombletEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(ClusterBombletEntity entity) {
        return TEXTURE;
    }
}
